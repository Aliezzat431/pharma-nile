...
${this.state.errorInfo?.componentStack || this.state.error.stack || "No trace available"}`;
 ...
 {}
 <div className="w-16 h-16 rounded-2xl bg-rose-500/10 flex items-center justify-center border border-rose-500/25 shadow-[0_0_20px_rgba(244,63,94,0.15)] ">
 ...
 className="flex items-center gap-2 px-6 py-3 bg-glass-surface hover:brightness-110 text-white font-black text-sm rounded-xl transition-all shadow-[0_0_15px_rgba(244,63,94,0.25)] hover:scale-102 active:scale-98 cursor-pointer"
 >
