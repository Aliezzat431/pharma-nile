...
export function Sidebar() {
 ...
 <div className="w-10 h-10 rounded-xl flex items-center justify-center " style={{ backgroundColor: 'var(--nile-teal)' }}>
 <PlusSquare className="text-[var(--background)] w-6 h-6" />
 </div>
 <h1 className="text-xl font-bold tracking-tight text-nile-teal font-medium font-cairo">
 صيدليتي بلس
 </h1>
 </div>
 ...
 {isActive && (
 <div className="absolute left-4 w-1 h-5 rounded-full " style={{ backgroundColor: 'var(--nile-teal)' }} />
 )}
 </Link>
 );
 })}
