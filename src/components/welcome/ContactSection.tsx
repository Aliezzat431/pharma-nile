        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full py-4 mt-2 rounded-2xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:brightness-110 text-[var(--text-primary)] font-extrabold text-sm flex items-center justify-center gap-2.5 shadow-xl shadow-emerald-500/20 active:scale-[0.97] transition-all cursor-pointer"
            >
