...
function TestimonialCard({ testimonial, isActive }: { testimonial: typeof testimonials[0]; isActive: boolean }) {
 ...
 <div className={`w-11 h-11 rounded-full bg-glass-surface ${testimonial.color} flex items-center justify-center text-[var(--text-primary)] font-black text-sm shrink-0`}>
