...
export default function Hero({ onOpenWizard }: HeroProps) {
 ...
 <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-cyan-500/10 rounded-full blur-[150px] " style={{ animationDelay: '2s' }} />
 </div>
 ...
 >
 تخلص من فوضى الجرد وأدر صيدليتك بنظام <span className="text-nile-teal font-medium">سحابي مرن</span>
 </motion.h1>
 ...
 className="w-full sm:w-auto px-10 py-5 bg-glass-surface hover:brightness-110 text-[var(--text-primary)] font-extrabold text-base rounded-2xl shadow-xl hover:scale-105 active:translate-y-[2px] transition-all flex items-center justify-center gap-2 group cursor-pointer"
 >
