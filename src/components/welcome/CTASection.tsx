...
export default function CTASection({ onOpenWizard }: CTASectionProps) {
 ...
 <br />
 <span className="text-nile-teal font-medium">يعمل بجد مثلك</span>
 </h2>
 ...
 whileTap={{ scale: 0.97 }}
 className="w-full sm:w-auto px-10 py-5 bg-glass-surface text-[var(--text-primary)] font-extrabold text-base rounded-2xl shadow-2xl shadow-blue-500/20 flex items-center justify-center gap-2.5 group cursor-pointer"
 >
