...
export default function WizardModal({ isOpen, onClose }: WizardModalProps) {
 ...
 type="submit"
 disabled={isLoading}
 className="w-full py-3 bg-glass-surface text-[var(--text-primary)] font-bold text-sm rounded-xl hover:scale-[1.01] active:translate-y-[2px] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
 >
 {isLoading ? (
 <>
