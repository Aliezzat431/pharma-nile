...
const menuGroups: MenuGroup[] = [
 ...
 { icon: Users, label: 'العملاء', href: '/customers', rolesRequired: ['manager'] },
 { icon: History, label: 'المرتجعات', href: '/returns', rolesRequired: ['manager'] },
 ]
 },
 {
 ...
 { icon: FileUp, label: 'استيراد فاتورة', href: '/invoices/import', rolesRequired: ['manager'] },
 { icon: BadgeDollarSign, label: 'الماليات', href: '/financials', rolesRequired: ['manager'] },
 ...
 title: 'النظام',
 items: [
 { icon: Users, label: 'الموظفين', href: '/staff', rolesRequired: ['admin', 'chain_admin', 'manager'] },
 { icon: Settings, label: 'الإعدادات', href: '/settings', rolesRequired: ['admin', 'chain_admin', 'manager'] },
 { icon: Code, label: 'لوحة المطور', href: '/dev', rolesRequired: ['developer'] },
 ]
 }
];
...
export default function Sidebar() {
 ...
 <div className={`flex items-center gap-3 bg-glass-surface bg-[var(--nile-teal)]/10 p-3 rounded-2xl border-r-4 border-[var(--nile-teal)] relative group overflow-hidden`}>
 <div className="w-12 h-12 min-w-[48px] rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)] flex items-center justify-center shadow-[0_0_20px_var(--nile-teal-glow)] z-10 transition-transform group-hover:rotate-12 group-hover:scale-110">
 <Sparkles className="w-6 h-6 text-black" />
 </div>
 {!isCollapsed && (
 <div className="animate-in fade-in slide-in- duration-500">
 <h1 className="text-2xl font-black text-nile-teal font-medium tracking-tight font-cairo">
 ...
 return !item.rolesRequired || item.rolesRequired.includes(effectiveRole) || (item.rolesRequired.includes('developer') && realRole === 'developer') ||(['admin', 'chain_admin', 'developer'].includes(realRole));
 }).map((item) => {
 ...
 className="absolute inset-0 bg-glass-surface from-[var(--nile-teal-glow)] border-r-4 border-[var(--nile-teal)] rounded-xl -z-10 shadow-[inner_0_0_20px_var(--nile-teal-glow)]"
 ...
 <div className="w-10 h-10 rounded-full bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)] p-[2px]">
