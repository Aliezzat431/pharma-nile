...
export default function WelcomeOverlay({ onComplete }: { onComplete: () => void }) {
 ...
 <motion.div 
 className="h-full bg-[var(--nile-teal)] "
 initial={{ width: 0 }}
 ...
 <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[var(--nile-teal-glow)] rounded-full blur-[150px] " />
 <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[var(--royal-gold-glow)] rounded-full blur-[150px] " style={{ animationDelay: '2s' }} />
 ...
 <div className="absolute inset-0 bg-[var(--nile-teal-glow)] blur-3xl " />
 <div className="w-full h-full bg-glass-surface from-[var(--glass-surface-heavy)] backdrop-blur-xl border border-[var(--glass-border)] rounded-[2.5rem] flex items-center justify-center shadow-2xl overflow-hidden group">
 <Pill className="w-14 h-14 text-[var(--nile-teal)] transition-transform group-hover:scale-125" />
 <div className="absolute inset-x-0 bottom-0 h-1/2 bg-glass-surface from-[var(--nile-teal-glow)] " />
 </div>
 </div>
 ...
 >
 <div className="absolute inset-0 bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
 ...
 {}
 <div className="absolute inset-x-0 h-[100px] bg-glass-surface via-[var(--nile-teal-glow)] top-0 animate-scanline pointer-events-none" />
