...
export default function LayoutWrapper({ children }: { children: React.ReactNode }) {
 ...
 className="w-full py-3.5 rounded-xl bg-glass-surface from-[var(--royal-gold)] to-[#f2cd56] text-[var(--background)] font-bold font-cairo hover:shadow-[0_0_20px_var(--royal-gold-glow)] transition-all hover:scale-[1.02] active:scale-95 text-sm"
 >
 ...
 {jardSession && (
 <div className="bg-glass-surface from-[var(--nile-teal)]/20 to-[var(--nile-teal)]/40 text-[var(--nile-teal)] text-sm py-2 px-4 text-center font-bold font-cairo flex items-center justify-center gap-2 border-b border-[var(--nile-teal)]/20 z-50">
 ...
 {!isOnline && (
 <div className="bg-glass-surface text-white text-[11px] py-1.5 px-4 text-center font-semibold font-cairo flex items-center justify-center gap-2 border-b border-amber-500/25 animate-in slide-in- duration-300 z-50">
