...
export default function ChatWidget() {
 ...
 isMe 
 ? 'bg-glass-surface from-[var(--nile-teal)] to-[#009b9e] text-white rounded-bl-none' 
 ...
 : 'bg-glass-surface from-[var(--nile-teal)] to-[#009b9e] text-white hover:shadow-[0_0_20px_rgba(0,206,209,0.5)]'
 }`}
 >
