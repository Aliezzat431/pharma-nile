...
export default async function FeaturePage({ params }: { params: Promise<Params> }) {
 ...
 <div className={`w-16 h-16 rounded-3xl bg-glass-surface ${feature.color} flex items-center justify-center shadow-2xl`}>
 ...
 <Link
 href="/welcome"
 className="inline-flex items-center gap-2.5 px-10 py-5 bg-glass-surface text-white font-extrabold text-base rounded-2xl shadow-xl hover:brightness-110 active:scale-[0.97] transition-all"
 >
