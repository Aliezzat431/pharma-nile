...
export default function JardWizardPage() {
 ...
 <h1 className="text-3xl font-bold font-cairo text-nile-teal font-medium mb-4">الجرد العكسي (مساعد الجرد)</h1>
 ...
 className="px-6 py-3 bg-glass-surface from-[var(--nile-teal)] to-[#01AFB2] text-black font-bold rounded-xl flex items-center gap-2 shadow-xl hover:scale-105 transition-all"
 >
