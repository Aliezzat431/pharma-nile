...
export default function ImportInventoryPage() {
 ...
 <h1 className="text-4xl font-bold font-cairo tracking-tight">استيراد <span className="text-nile-teal font-medium">المخزون</span></h1>
 ...
 className="h-full bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)]"
 />
 </div>
 </div>
 </div>
