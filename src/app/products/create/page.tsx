...
export default function CreateProduct() {
 ...
 >
 <Sparkles className={`w-4 h-4 ${loading ? '' : ''}`} />
 ...
 disabled={loading}
 type="submit" 
 className="flex items-center gap-2 px-8 py-4 rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[#009b9e] text-white font-bold hover:shadow-[0_0_15px_rgba(0,206,209,0.4)] transition-all disabled:opacity-50 font-cairo"
 >
