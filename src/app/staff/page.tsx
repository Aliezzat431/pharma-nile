...
export default function StaffManagement() {
 ...
 إدارة <span className="text-nile-teal font-medium">فريق العمل</span>
 </h1>
 ...
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="glass-card p-8 flex flex-col gap-4 border-[var(--nile-teal)]/20 relative overflow-hidden group">
 <div className="flex justify-between items-center z-10">
 ...
 <div className="w-12 h-12 rounded-xl bg-glass-surface from-[var(--nile-teal)]/20 to-[var(--royal-gold)]/20 flex items-center justify-center font-bold text-[var(--nile-teal)] border border-[var(--glass-border)] group-hover:scale-110 transition-transform">
