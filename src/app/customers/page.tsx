...
export default function CustomersPage() {
 ...
 <span className="text-nile-teal font-medium">إدارة العملاء</span>
 </motion.h1>
 <motion.p 
 initial={{ opacity: 0, x: -20 }}
 animate={{ opacity: 1, x: 0 }}
 ...
 >
 <div className="absolute inset-0 bg-glass-surface /5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0 pointer-events-none" />
