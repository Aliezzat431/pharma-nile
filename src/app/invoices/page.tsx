...
export default function InvoicesPage() {
 ...
 className="w-12 h-12 rounded-2xl bg-glass-surface from-[var(--royal-gold)] to-[var(--nile-teal)] flex items-center justify-center shadow-[0_0_20px_var(--royal-gold-glow)] relative"
 >
 <div className="absolute inset-0 rounded-2xl bg-white/20 blur-md" />
 <FileText className="text-black w-6 h-6 z-10" />
 </motion.div>
 <span className="text-nile-teal font-medium">سجل الفواتير</span>
 </motion.h1>
 <motion.p
 initial={{ opacity: 0, x: -20 }}
 animate={{ opacity: 1, x: 0 }}
