...
export default function InvoiceImportPage() {
 ...
 if (!newProduct) throw new Error('فشل في إنشاء المنتج الجديد (No data returned)');
 ...
 <div>
 <h1 className="text-3xl font-bold font-cairo text-nile-teal font-medium">
 استيراد فاتورة
 </h1>
...
function ItemsPanel({
 ...
 <Sparkles className="w-5 h-5 absolute text-[var(--royal-gold)] " />
 </div>
 <p className="font-cairo text-lg text-white font-bold ">جاري قراءة الأصناف...</p>
