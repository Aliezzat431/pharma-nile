...
export function POSRecommendations({ suggestions, visible, onSelect, loading }: POSRecommendationsProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute z-[100] top-full left-0 right-0 mt-2 bg-[#0d0d0d] border border-[var(--glass-border)] rounded-xl shadow-[0_12px_40px_rgba(0,0,0,0.7)] overflow-hidden backdrop-blur-xl"
    >
          ...
          suggestions.map((p, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-8 h-8 rounded-lg bg-[var(--glass-surface)] flex items-center justify-center group-hover:bg-[var(--nile-teal)]/20 transition-colors">
