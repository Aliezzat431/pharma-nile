...
export function VirtualReceipt({
 ...
 className="relative w-full max-w-[370px] bg-glass-surface from-[#fbfbfa] via-[#f7f7f4] to-[#f2f2ed] text-zinc-900 rounded-lg shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] border border-white/20 select-none overflow-hidden"
 style={{
 ...
 >
 {}
 <div className="h-3 bg-glass-surface from-[var(--royal-gold)] to-[#f2cd56]"></div>
 ...
 {}
 <div className="h-6 bg-glass-surface "></div>
 </motion.div>
 ...
 <button
 onClick={handlePrint}
 className="w-full py-4 px-6 rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[#00a2a5] text-white font-bold hover:shadow-[0_0_20px_rgba(0,206,209,0.4)] flex items-center justify-center gap-3 transition-all hover:scale-105 active:scale-95 group"
 >
 <Printer className="w-5 h-5 group-hover:" />
