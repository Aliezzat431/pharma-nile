...
export default function POSTerminal() {
  ...
  const executeCheckoutProcess = async (cartToProcess: any[], totalToProcess: number) => {
    ...
    for (const item of cartToProcess) {
      ...
      // Calculate total requested quantity in smallest unit or standard unit depending on conversion.
      // (The quantity in cart is already converted visually, but let's compare with activeBatches sum)
