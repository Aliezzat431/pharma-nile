...
export default function CopilotPage() {
 ...
 {/* Header */}
 <div className="px-4 py-3 border-b border-[var(--glass-border)] bg-glass-surface from-[var(--nile-teal)]/8 flex items-center justify-between shrink-0">
 <div className="flex items-center gap-3">
 <div className="relative">
 <div className="w-10 h-10 rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[var(--nile-teal)]/50 flex items-center justify-center shadow-lg shadow-[var(--nile-teal)]/20">
 ...
 msg.role === 'user'
 ? 'bg-glass-surface /12 /6 text-white border border-white/10 rounded-br-sm'
 : 'bg-glass-surface from-[var(--nile-teal)]/12 to-[var(--nile-teal)]/5 text-gray-100 border border-[var(--nile-teal)]/20 rounded-bl-sm mr-6'
 }`}
 >
 {msg.role === 'assistant' ? (
 ...
 >
 <div className="absolute inset-0 bg-glass-surface from-[var(--nile-teal)]/6 pointer-events-none" />

 <div className="flex items-center gap-2 mb-2 relative z-10">
 <AlertCircle className="w-3.5 h-3.5 text-[var(--nile-teal)] shrink-0" />
 ...
 >
 <div className="bg-glass-surface from-[var(--nile-teal)]/12 to-[var(--nile-teal)]/5 p-3.5 rounded-2xl rounded-bl-sm flex items-center gap-3 border border-[var(--nile-teal)]/20 mr-6 max-w-[85%]">
 <div className="flex gap-1 shrink-0">
 {[0, 150, 300].map(delay => (
 <div
 key={delay}
 className="w-1.5 h-1.5 bg-[var(--nile-teal)] rounded-full "
 ...
 className="w-9 h-9 shrink-0 rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[var(--nile-teal)]/80 text-black flex items-center justify-center hover:shadow-lg hover:shadow-[var(--nile-teal)]/25 transition-all disabled:opacity-30 disabled:pointer-events-none"
 >
 ...
 className="absolute bottom-[-9px] left-2 right-2 h-[2px] bg-glass-surface via-[var(--nile-teal)] "
 />
 )}
 </motion.button>
 );
 ...
 className="relative"
 >
 <div className="w-28 h-28 rounded-[1.75rem] bg-glass-surface from-[var(--nile-teal)] to-[var(--nile-teal)]/30 flex items-center justify-center shadow-[0_0_60px_rgba(0,206,209,0.25)]">
 <Sparkles className="w-14 h-14 text-black" />
 </div>
 <div className="absolute -top-2 -right-2 w-7 h-7 bg-[#FF69B4] rounded-full flex items-center justify-center shadow-lg">
