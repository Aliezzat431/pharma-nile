...
export default function ShortagesPage() {
 ...
 className="w-12 h-12 rounded-2xl bg-glass-surface to-[var(--royal-gold)] flex items-center justify-center shadow-[0_0_20px_rgba(239,68,68,0.3)] relative shrink-0"
 >
 <div className="absolute inset-0 rounded-2xl bg-white/20 blur-md" />
 <AlertCircle className="text-black w-6 h-6 z-10" />
 </motion.div>
 <span className="text-nile-teal font-medium">إدارة النواقص</span>
 </motion.h1>
 <motion.p
 initial={{ opacity: 0, x: -20 }}
 animate={{ opacity: 1, x: 0 }}
 ...
 ${selectedIds.size > 0
 ? 'bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)] text-black shadow-[0_0_20px_var(--nile-teal-glow)] hover:scale-105'
