...
export default function Loading() {
 ...
 <div className="w-10 h-10 bg-glass-surface rounded-full shadow-[0_0_20px_rgba(37,99,235,0.4)]"></div>
 </div>
 
 <div className="flex flex-col items-center space-y-2 text-center">
 <div className="flex items-center space-x-2 rtl:space-x-reverse">
 <h3 className="text-xl font-bold bg-glass-surface bg-clip-text text-transparent">
 جاري التحميل
 </h3>
 <div className="flex space-x-1 rtl:space-x-reverse h-6 items-end pb-1">
 <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full " style={{ animationDelay: '0ms' }}></div>
 <div className="w-1.5 h-1.5 bg-blue-600 rounded-full " style={{ animationDelay: '150ms' }}></div>
 <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full " style={{ animationDelay: '300ms' }}></div>
 </div>
 </div>
