  ...
  return (
    ...
    >
      <div className="glass-panel p-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--royal-gold)]/5 rounded-full blur-3xl -z-10 pointer-events-none"></div>
        <h2 className="text-xl font-bold mb-6 border-b border-[var(--glass-border)] pb-4 font-cairo flex items-center gap-2">
          <Shield className="w-5 h-5 text-[var(--royal-gold)]" /> بيانات الصيدلية الأساسية
        </h2>
        ...
        <div className="space-y-5">
          <div>
            ...
            <input 
              ...
              className="w-full bg-black/40 border border-[var(--glass-border)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--nile-teal)] transition-colors" 
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-black/40 border border-[var(--glass-border)] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--nile-teal)] transition-colors resize-none" 
            />
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel p-8 relative overflow-hidden">
        <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[var(--nile-teal)]/5 rounded-full blur-3xl -z-10 pointer-events-none"></div>
        <h2 className="text-xl font-bold mb-6 border-b border-[var(--glass-border)] pb-4 font-cairo flex items-center gap-2">
          <Shield className="w-5 h-5 text-[var(--nile-teal)]" /> تفضيلات النظام والمخزون
        </h2>
        ...
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between p-5 rounded-xl border border-[var(--glass-border)] bg-white/[0.02] hover:bg-white/[0.04] transition-colors gap-4">
            ...
            <select 
              ...
              className="bg-black/80 border border-[var(--glass-border)] rounded-lg px-4 py-2.5 text-white outline-none focus:border-[var(--royal-gold)] font-cairo min-w-[200px] cursor-pointer"
            >
