...
export function AboutSettings() {
 ...
 <div className="absolute inset-0 bg-glass-surface from-[var(--nile-teal)]/10 opacity-30" />
 
 <div className="relative z-10">
 <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 bg-glass-surface bg-clip-text text-transparent leading-tight font-cairo">
 ...
 <div className="absolute inset-0 bg-glass-surface from-[var(--nile-teal)]/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
