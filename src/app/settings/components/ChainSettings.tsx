...
export function ChainSettings() {
 ...
 if (error) throw error;
 if (!data) throw new Error('لم يتم إرجاع بيانات الصيدلية المضافة.');
 ...
 className="w-full py-3 bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)] text-black font-bold text-sm rounded-xl hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2"
 >
 {isAddingPharmacy ? (
 <>
 <Loader2 className="w-4 h-4 animate-spin" />
