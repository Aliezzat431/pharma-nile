...
export function DatabaseSettings() {
 ...
 {}
 <div className="mb-8 p-6 rounded-2xl border border-[var(--nile-teal)]/20 bg-glass-surface from-[var(--nile-teal)]/5 ">
 ...
 <motion.div
 className="h-full rounded-full bg-glass-surface from-[var(--nile-teal)] to-[var(--royal-gold)]"
 initial={{ width: 0 }}
