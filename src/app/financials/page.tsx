...
export default function FinancialsPage() {
 ...
 <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: 'linear' }} className="w-12 h-12 rounded-2xl bg-glass-surface to-[var(--nile-teal)] flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.3)] relative">
