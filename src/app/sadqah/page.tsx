...
export default function SadqahPage() {
 ...
 <div>
 <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-glass-surface font-cairo">
 ...
 <div className="glass-panel p-8 bg-glass-surface from-[#FF69B4]/10 border border-[#FF69B4]/20 min-h-[220px] flex flex-col justify-center">
