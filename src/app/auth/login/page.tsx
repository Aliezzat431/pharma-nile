...
export default function LoginPage() {
 ...
 className={`w-24 h-24 mx-auto bg-glass-surface rounded-[2rem] flex items-center justify-center mb-6 shadow-[0_0_40px_var(--nile-teal-glow)] relative group ${
 isDeveloperMode ? ' to-[var(--nile-teal)]' : 'from-[var(--nile-teal)] to-[var(--royal-gold)]'
 }`}
 >
 <div className="absolute inset-0 rounded-[2rem] bg-white/20 blur-xl opacity-0 transition-opacity group-hover:opacity-100" />
 {isDeveloperMode ? (
 <Code className="w-12 h-12 text-white z-10 " />
 ) : (
 ...
 className="text-4xl font-black mb-3 text-nile-teal font-medium tracking-tight"
 >
 ...
 >
 <div className="absolute inset-0 bg-glass-surface /40 skew-x-[20deg] w-1/3 -translate-x-[200%] group-hover:translate-x-[300%] transition-transform duration-1000 ease-in-out" />
 ...
 whileHover={{ scale: 1.02 }}
 whileTap={{ scale: 0.98 }}
 className="relative w-full py-4 rounded-2xl font-bold text-lg transition-all flex items-center justify-center gap-3 overflow-hidden bg-glass-surface from-[var(--nile-teal)] to-[color:var(--royal-gold)] text-black"
 >
