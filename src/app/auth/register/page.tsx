...
export default function RegisterPage() {
 ...
 <div className="w-20 h-20 mx-auto bg-glass-surface from-[var(--nile-teal)] to-[var(--nile-teal)]/20 rounded-[2rem] flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(0,206,209,0.2)] border border-[var(--nile-teal)]/20">
 <UserPlus className="w-10 h-10 text-white" />
 </div>
 <h1 className="text-3xl font-black bg-clip-text text-transparent bg-glass-surface mb-2">
 ...
 className="w-full py-4 rounded-xl bg-glass-surface from-[var(--nile-teal)] to-[#009b9e] text-black font-bold hover:opacity-90 hover:shadow-[0_0_20px_rgba(0,206,209,0.2)] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4 text-sm"
 >
 {isLoading ? (
 <>
